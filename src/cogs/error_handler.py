...
class error_handler(commands.Cog):
	...
	async def on_command_error(self, ctx, error):
		...
		if isinstance(error, commands.BadArgument):
			...
			await ctx.reply("P-Pervert! <a:LoliTriggered:754632379397570620>\n``This command can only be ran in an nsfw channel``")
			return await ctx.send("https://cdn.discordapp.com/attachments/814084836800856086/1048202311874396180/image.png")
